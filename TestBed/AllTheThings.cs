...
public static class FooExt
{
    ...
    public static Foo<Func<B, C>> Apply<A, B, C>(this Foo<Func<A, B, C>> f, Foo<A> a) => Apply(f.Map(Curry), a);
    public static Foo<Func<B, C, D>> Apply<A, B, C, D>(this Foo<Func<A, B, C, D>> f, Foo<A> a) => Apply(f.Map(CurryFirst), a);
